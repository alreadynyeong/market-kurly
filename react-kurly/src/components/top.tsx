...
import { faBars, faHeart, faLocationDot, faSearch, faShoppingCart } from '@fortawesome/free-solid-svg-icons'
...
export default function Top() {
  return (
    <Container>
        <Menu>
            <Link to="/signup"><Purple>회원가입</Purple> |</Link>
        ...
        <Kurly>
            <a id="purple" href="#"><Purple>마켓컬리 </Purple> </a>
            <a href="#">| 뷰티컬리</a>
        </Kurly>
